...
ERROR_DESCRIPTIONS: dict[ErrorCode, str] = {
    ...
    ErrorCode.WATERMARK_NOT_FOUND: "Job watermark tidak ditemukan.",
    ErrorCode.WATERMARK_NOT_READY: "Watermark belum selesai (status bukan success).",
    ErrorCode.WATERMARK_FILE_MISSING: "File hasil watermark tidak ada di storage.",
    ErrorCode.DOCUMENT_NOT_INDEXED: "Arsip ada tetapi belum ter-index.",
    ErrorCode.DOCUMENT_FILE_MISSING: "File arsip tidak ditemukan di storage.",
    ...
    ErrorCode.PDF_GENERATE_FAILED: "Gagal membuat PDF (generator test).",
