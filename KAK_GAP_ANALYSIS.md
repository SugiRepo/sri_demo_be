...
| §1.5.3 | API interoperabilitas + skema metadata + error checking + jejak aktivitas | 🟡 | API REST ada (OpenAPI), tapi belum ada skema metadata sesuai standar SPBE/ANRI, audit trail per dokumen, dan error contract terstandar. |
